...
@section('contents')
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="text-muted {{ session()->get('direction') == 2 ? 'breadcrumb-item-rtl' : 'breadcrumb-item' }} active" aria-current="page">{{ trans('labels.privacy_policy') }}</li>
    ...
    <section class="privacy-policy my-5">
        ...
        <div class="container">
            <p>{!! $privacypolicy->privacy_content !!}</p>
