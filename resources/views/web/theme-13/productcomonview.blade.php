...
<div class="col-xl-6 col-lg-6 col-md-12 col-12">
    <a href="{{ URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug) }}">
        ...
        <div class="item h-100 p-2 d-flex bg-primary-rgb rounded-2 align-items-center border-0">
            ...
            <div class="w-100 {{ session()->get('direction') == 2 ? 'pe-md-3 pe-2' : 'ps-md-3 ps-2' }}">
                ...
                <div class="p-0">
                    <h6 class="text-dark fs-7 fw-600 mt-3 mb-2 cursor-auto text-truncate d-flex align-items-center">
                        ...
                        @if ($original_price > $price)
                            <del
                                class="text-muted fs-8 fw-normal d-block px-1">{{ helper::currency_formate($original_price, $getproductdata->vendor_id) }}</del>
                        @endif
