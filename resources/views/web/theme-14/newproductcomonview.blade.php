...
<div class="col-xl-4 col-md-6 col-12">
    <a href="{{ URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug) }}">
        ...
        <div class="item border h-100 p-2 d-flex bg-white rounded-2 align-items-center  ">
            ...
            <div class="w-100 h-100 position-relative {{ session()->get('direction') == 2 ? 'pe-md-3 pe-2' : 'ps-3' }}">
                ...
                <ul class="option-wrap d-flex gap-2 align-items-center d-grid product_icon2 mt-2">
                    @if (@helper::checkaddons('customer_login'))
                        ...
                        @endif
                    @endif
                    <li tooltip="{{ trans('labels.view') }}" class="rounded-3 border">
                    ...
                    @if (helper::appdata($vendordata->id)->online_order == 1)
                        <li tooltip="{{ trans('labels.addtocart') }}" class="rounded-3 border">
