        ...
        <div class="item h-100 p-2 d-flex">
            <div class="col-5">
                ...
                <div class="item-img position-relative">
                    ...
                    @if ($off > 0)
                        <div class="sale-label">{{ $off }}% {{ trans('labels.off') }}</div>
                    @endif
                    <!-- options -->
                    <ul
            ...
            <div class="col-7 {{ session()->get('direction') == 2 ? 'pe-2' : 'ps-2' }}">
                <div class="card-body item-content pb-0 h-93 {{ session()->get('direction') == 2 ? 'pe-1' : 'ps-1' }}">
                    <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        @if (helper::appdata($vendordata->id)->product_ratting_switch == 1)
                            <p class="fs-8 d-flex">
                                <i
                                    class="text-warning fa-solid fa-star {{ session()->get('direction') == 2 ? 'ps1' : 'pe-1' }}"></i>
                                <span
                ...
                <div class="card-footer {{ session()->get('direction') == 2 ? 'pe-1' : 'ps-1' }}">
                            ...
                            @if ($getproductdata->has_variation == 1)
                                <a href="{{ URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug) }}"
                                    ...
                                    <div class="product-cart-button w-100">
                                        ...
                                        <p
                                            class="fw-500 text-capitalize fs-7 {{ session()->get('direction') == 2 ? 'pe-1' : 'ps-1' }}">
