                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a tooltip="{{ trans('labels.inactive') }}"
                                                        ...
                                                        class="btn btn-sm hov btn-outline-danger {{ Auth::user()->type == 4 ? (helper::check_access('role_language_settings', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a tooltip="{{ trans('labels.inactive') }}"
                                                        ...
                                                        class="btn btn-sm hov btn-danger {{ Auth::user()->type == 4 ? (helper::check_access('role_language_settings', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">
                                                        <i class="fas fa-close mx-1"></i>
                                                    </a>
                                                @endif
                                            </td>
