                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control" name="widget_id" placeholder="<script type=&quot;text/javascript&quot;></script>" required>{{ @$settingdata->tawk_widget_id }}</textarea>
