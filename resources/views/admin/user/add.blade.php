    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="{{ URL::to('admin/users') }}">{{ trans('labels.vendors') }}</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group {{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                        ...
                        <button
                            ...
                            class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_vendors', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">{{ trans('labels.save') }}</button>
                    </div>
                    </form>
