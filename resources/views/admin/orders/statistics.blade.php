            ...
            <div class="card-body">
                <div class="dashboard-card">
                    ...
                    <span class="{{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                        ...
                        <h5 class="text-primary fw-600">{{ $totalprocessing }}</h4>
                    </span>
                </div>
            </div>
            </a>
        ...
        <div
            ...
            <div class="card-body">
                <div class="dashboard-card">
                    ...
                    <span class="{{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                        <p class="text-dark fs-15 fw-500 mb-1">{{ trans('labels.delivered') }}</p>
                        <h5 class="text-primary fw-600">{{ $totalcompleted }}</h4>
                    </span>
                </div>
            </div>
            </a>
            ...
            <div class="card-body">
                <div class="dashboard-card">
                    ...
                    <span class="{{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                        ...
                        <h5 class="text-primary fw-600">{{ $totalcancelled }}</h4>
                    </span>
                </div>
            </div>
            </a>
                ...
                <div class="card-body">
                    <div class="dashboard-card">
                        ...
                        <span class="{{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                            ...
                            <h5 class="text-primary fw-600">{{ helper::currency_formate($totalrevenue, $vendor_id) }}
                                </h4>
                        </span>
                    </div>
                </div>
