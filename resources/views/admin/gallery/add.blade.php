                    ...
                    <form action="{{ URL::to('/admin/gallery/save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                            ...
                            <button
                                ...
                                class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_gallery', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">{{ trans('labels.save') }}</button>
                        </div>
