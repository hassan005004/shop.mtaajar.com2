...
@section('content')
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ URL::to('admin/how_it_works/add') }}" class="btn btn-secondary px-sm-4 d-flex">
...
<td></td>
                                ...
                                <tbody id="tabledetails" data-url="{{url('admin/how_it_works/reorder_how_work')}}">
                                    ...
                                    <tr class="fs-7 align-middle row1" id="dataid{{$data->id}}" data-id="{{$data->id}}">
                                    <td><a tooltip="{{trans('labels.move')}}"><i class="fa-light fa-up-down-left-right mx-2"></i></a></td>
                                            ...
                                            <td> <img src="{{ helper::image_path($data->image) }}" class="img-fluid rounded hight-50 object-fit-cover"  alt=""></td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ URL::to('/admin/how_it_works/edit-' . $data->id) }}"
                                                        ...
                                                        class="btn btn-info btn-sm hov" tooltip="{{trans('labels.edit')}}"> <i
