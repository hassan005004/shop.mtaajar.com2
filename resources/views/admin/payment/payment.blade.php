...
@section('content')
    <div class="d-flex align-items-center mb-3">
        <h5 class="text-capitalize fw-600 text-dark fs-4">{{ trans('labels.payment_settings') }}</h5>
    </div>
    <div class="row">
        <div class="col-12">
                                    ...
                                    <div class="payment-accordian card rounded border mb-3 handle">
                                        <h2 class="card-header text-white d-flex align-items-center rounded border-0 justify-content-between"
                                            ...
                                            <div>
                                                ...
                                                @if (!in_array($transaction_type, ['1', '16']))
                                            ...
                                            <a class="cursor-pointer text-white" tooltip="{{ trans('labels.move') }}"><i
