                        ...
                        <table class="table table-striped table-bordered py-3 zero-configuration w-100 dataTable no-footer">
                            ...
                            <tbody id="tabledetails" data-url="{{ url('admin/features/reorder_features') }}">
                                ...
                                @foreach ($features as $feature)
                                    <tr class="fs-7 align-middle row1" id="dataid{{ $feature->id }}"
                                        data-id="{{ $feature->id }}">
                                        ...
                                        <td>{{ helper::date_formate($feature->created_at, $feature->vendor_id) }}<br>
                                            {{ helper::time_formate($feature->created_at, $feature->vendor_id) }}
                                        </td>
                                        <td>{{ helper::date_formate($feature->updated_at, $feature->vendor_id) }}<br>
                                            {{ helper::time_formate($feature->updated_at, $feature->vendor_id) }}
                                        </td>
                                        <td>
