                    ...
                    <form action="{{ URL::to('/admin/faqs/update-' . $getfaq->id) }}" method="POST"
                        ...
                        <div class="form-group {{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                            ...
                            <button
                                ...
                                class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_faqs', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}">{{ trans('labels.save') }}</button>
