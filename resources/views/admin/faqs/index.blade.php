...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ URL::to('admin/faqs/add') }}"
            class="btn btn-secondary px-sm-4 text-capitalize d-flex {{ Auth::user()->type == 4 ? (helper::check_access('role_faqs', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <a href="javascript:void(0)" tooltip="{{ trans('labels.delete') }}"
                                                    ...
                                                    class="btn btn-danger hov btn-sm {{ Auth::user()->type == 4 ? (helper::check_access('role_faqs', Auth::user()->role_id, Auth::user()->vendor_id, 'delete') == 1 ? '' : 'd-none') : '' }}">
