                    ...
                    <form method="POST" action="{{ URL::to('admin/age_verification') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label class="form-label" for="">{{ trans('labels.age_verification') }} </label>
                        ...
                        <div class="text-end">
                            <button
                                ...
                                class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_basic_settings', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}">{{ trans('labels.save') }}
                            </button>
                        </div>
                    </form>
                </div>
