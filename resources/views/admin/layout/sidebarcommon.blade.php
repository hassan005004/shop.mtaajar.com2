...
<ul class="navbar-nav {{ session()->get('direction') == 2 ? 'left-padding-rtl' : 'right-padding-ltr' }}">
    ...
    @if (Auth::user()->type == '1' || @helper::checkaddons('customer_login'))
    ...
    @if (Auth::user()->type == '1')
        <li class="nav-item mb-2 fs-7">
            <a class="nav-link rounded d-flex {{ request()->is('admin/users*') ? 'active' : '' }}" aria-current="page"
                ...
                <span class="">{{ trans('labels.users') }}</span>
            </a>
        </li>
    @endif
    ...
    @endif
    <li
        class="nav-item mt-3 {{ helper::check_menu($role_id, 'role_subscription') == 1 ||
     ...
     @if (Auth::user()->type == 2 || Auth::user()->type == 4)
        <li
            ...
            <a class="nav-link rounded d-flex {{ request()->is('admin/shipping-area*') ? 'active' : '' }}"
                ...
                <i class="fas fa-chart-area"></i> <span class="">{{ trans('labels.shipping_area') }}</span>
            </a>
        </li>
    @endif
    @if (Auth::user()->type == 1)
    ...
    {{-- other --}}
    <li
        class="nav-item mt-3 {{ helper::check_menu($role_id, 'role_subscribers') == 1 || helper::check_menu($role_id, 'role_inquiries') == 1 || helper::check_menu($role_id, 'role_share') == 1 || helper::check_menu($role_id, 'role_setting') == 1 ? 'd-block' : 'd-none' }}">
