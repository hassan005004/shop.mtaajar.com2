...
<div class="d-flex justify-content-between align-items-center">
    ...
    <a href="{{ URL::to('admin/promotionalbanners/add') }}" class="btn btn-secondary px-sm-4 text-capitalize d-flex">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered py-3 zero-configuration w-100 dataTable no-footer">
                        ...
                        <tbody id="tabledetails"
                            ...
                            @endphp</td>
                            <td><img src="{{ helper::image_path($banner->image) }}" class="hight-50" alt=""></td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="javascript:void(0)" tooltip="{{ trans('labels.delete') }}"
                                        ...
                                        onclick="statusupdate('{{ URL::to('admin/promotionalbanners/delete-'.$banner->id) }}')"
