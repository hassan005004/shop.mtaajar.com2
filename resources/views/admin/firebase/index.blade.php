                    ...
                    <div class="row">
                        ...
                        <div class="{{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                            <button
                                ...
                                class="btn btn-primary px-sm-4  {{ Auth::user()->type == 4 ? (helper::check_access('role_firebase_notification', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">{{ trans('labels.save') }}</button>
                        </div>
                    </div>
                </div>
            </form>
            <div class="card border-0 mb-3 box-shadow">
                <div class="{{ session()->get('direction') == 2 ? 'text-start' : 'text-end' }}">
                    <a href="{{ URL::to('admin/notification/add') }}"
                        class="btn btn-secondary px-sm-4 text-capitalize mx-3 mt-3 {{ Auth::user()->type == 4 ? (helper::check_access('role_firebase_notification', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <a href="javascript:void(0)" tooltip="{{ trans('labels.delete') }}"
                                                    ...
                                                    onclick="statusupdate('{{ URL::to('/admin/notification/delete-' . $content->id) }}')" @endif
