    ...
    <div class="col-12">
        ...
        <div class="card border-0 box-shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ $url . '/update-' . $getbannerdata->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" value="{{$getbannerdata->title}}" name="banner_title" placeholder="{{ trans('labels.title') }}">
                            @error('banner_title')
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" value="{{$getbannerdata->sub_title}}" name="banner_subtitle" placeholder="{{ trans('labels.sub_title') }}">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <textarea rows="5" class="form-control" name="banner_description" placeholder="{{trans('labels.description')}}" placeholder="{{ trans('labels.description') }}">{{$getbannerdata->description}}</textarea>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" value="{{$getbannerdata->link_text}}" placeholder="{{ trans('labels.link_text') }}" name="banner_link_text">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <select class="form-select type" name="banner_info">
                                ...
                                <option value="3" {{ $getbannerdata->type == '3' ? 'selected' : '' }}>

                                    {{ trans('labels.custom_link') }}
                                </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group 1 gravity">
                            ...
                            <select class="form-select" name="category" id="category">
                                ...
                                <option value="{{ $item->id }}" {{ $item->id == $getbannerdata->category_id ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-6 form-group 2 gravity">
                            ...
                            <select class="form-select" name="product" id="product">
                                ...
                                <option value="{{ $item->id }}" {{ $item->id == $getbannerdata->product_id ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-6 form-group 3 gravity">
                                ...
                                <input type="text" name="custom_link" class="form-control" value="{{$getbannerdata->custom_link}}" id="custom_link">
                                @error('custom_link')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <img src="{{ helper::image_path($getbannerdata->image) }}" class="img-fluid rounded hw-50 mt-1" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group {{session()->get('direction') == 2 ? 'text-start' : 'text-end'}}">
                            ...
                            <a href="{{ $url }}" class="btn btn-danger px-sm-4">{{ trans('labels.cancel') }}</a>

                            <button class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access($title == trans('labels.sliders')  ? 'role_sliders' : 'role_banner', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}" @if(env('Environment')=='sendbox' ) type="button" onclick="myFunction()" @else type="submit" @endif>{{ trans('labels.save') }}</button>
