                ...
                <nav aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <a href="{{ URL::to('admin/sub-categories') }}">{{ trans('labels.sub_categories') }}</a>
                ...
                <div class="col-12">
                    ...
                    <div class="card border-0 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ URL::to('admin/sub-categories/store') }}" method="POST">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <label class="form-label">{{ trans('labels.sub_category') }}<span class="text-danger">
                                ...
                                <div class="form-group {{session()->get('direction') == 2 ? 'text-start' : 'text-end'}}">
                                    ...
                                    <button class="btn btn-primary px-sm-4 {{ Auth::user()->type == 4 ? (helper::check_access('role_sub_categories', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : '' }}" @if(env('Environment')=='sendbox') type="button" onclick="myFunction()" @else type="submit" @endif>{{ trans('labels.save') }}</button>
