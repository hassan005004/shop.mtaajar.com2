...
function extras_fields(name, price) {
  ...
  divtest.innerHTML ='<div class="col-12 m-0 variations"><div class="row"><div class="col-md-6"><div class="form-group"><input type="text" class="form-control" name="extras_name[]" placeholder="' +
    name + '" required></div></div><div class="col-md-6"><div class="form-group"><div class="d-flex gap-2"><input type="number" step="any" class="form-control numbers_only" name="extras_price[]"  placeholder="' +
        ...
        for (i in response.responsdata) {
          {
            extras_row++;
            html +=
              '<div class="col-12 removeextras' +
              extras_row +
              '"><div class="row"><div class="col-md-6"><div class="form-group"><input type="text" class="form-control" name="extras_name[]" value="' +
              response.responsdata[i].name +
              '" placeholder="' +
              placehodername +
              '"></div></div><div class="col-md-6"><div class="form-group d-flex gap-2"><input type="number" step="any" class="form-control numbers_only" value="' +
