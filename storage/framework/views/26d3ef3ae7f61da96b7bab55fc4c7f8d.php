                    ...
                    <?php if(@helper::checkaddons('customer_login')): ?>
                        <?php if(helper::appdata($vendordata->id)->checkout_login_required == 1): ?>
                            <li data-tooltip="Wishlist"
                                class="rounded-0 mx-2 tooltip-<?php echo e(session()->get('direction') == 2 ? 'left' : 'right'); ?>">
            ...
            <div class="card-footer px-2 py-2">
                <h6
                    ...
                    <?php if($original_price > $price): ?>
                        <del
                            class="text-muted fs-8 fw-normal d-block mx-1"><?php echo e(helper::currency_formate($original_price, $getproductdata->vendor_id)); ?></del>
                    <?php endif; ?>
                </h6>
            </div>
        </div>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-15/productcomonview.blade.php ENDPATH**/ ?>