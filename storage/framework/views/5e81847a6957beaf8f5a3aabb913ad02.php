                            ...
                            <select name="template_type" id="template_type" class="form-select">
                                <?php if(Auth::user()->type == 1): ?>
                                    <option value="1" data-attribute="forgotpassword">
                                        <?php echo e(trans('labels.forgotpassword')); ?>
                            ...
                            <div id="templatemenuContent">
                                <?php if(Auth::user()->id == 1): ?>
                                    <div id="forgotpassword" class="hidechild">
                                        <div class="col-12">
                                            <h5 class="text-start">
                                                <?php echo e(trans('labels.forgotpassword')); ?> <?php echo e(trans('labels.variable')); ?>

                                            </h5>
                                            <hr>
                                            <p class="mb-1"><?php echo e(trans('labels.username')); ?> :
                                                <span class="pull-right text-primary">{user}</span>
                                            </p>
                                            <p class="mb-1"><?php echo e(trans('labels.password')); ?> :
                                    ...
                                    <div id="delete_account" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <hr>
                                            <p class="mb-1"><?php echo e(trans('labels.vendorname')); ?> :
                                    ...
                                    <div id="banktransfer_request" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.adminname')); ?> :
                                                <span class="pull-right text-primary">{adminname}</span>
                                            </p>
                                            <p class="mb-1"><?php echo e(trans('labels.adminemail')); ?> :
                                    ...
                                    <div id="subscription_reject" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.plan_name')); ?> :
                                    ...
                                    <div id="subscription_success" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.subscription_duration')); ?> :
                                                <span class="pull-right text-primary">{subscription_duration}</span>
                                            </p>
                                            <p class="mb-1"><?php echo e(trans('labels.subscription_cost')); ?> :
                                    ...
                                    <div id="admin_subscription_request" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.vendoremail')); ?> :
                                    ...
                                    <div id="admin_vendor_register" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.vendormobile')); ?> :
                                ...
                                <div id="contact_email" class="hidechild">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-1"><?php echo e(trans('labels.useremail')); ?> :
                                            <span class="pull-right text-primary">{useremail}</span>
                                        </p>
                                        <p class="mb-1"><?php echo e(trans('labels.usermobile')); ?> :
                                            <span class="pull-right text-primary">{usermobile}</span>
                                        </p>
                                        <p class="mb-1"><?php echo e(trans('labels.usermessage')); ?> :
                                ...
                                <?php if(Auth::user()->type == 2 || Auth::user()->type == 4): ?>
                                    <div id="new_order_invoice" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.order_date')); ?> :
                                    ...
                                    <div id="order_status" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <p class="mb-1"><?php echo e(trans('labels.status_message')); ?> :
                                    ...
                                    <div id="referral_earning" class="hidechild">
                                        <div class="col-12">
                                            ...
                                            <hr>
                                            <p class="mb-1"><?php echo e(trans('labels.referral_user')); ?> :
                                                <span class="pull-right text-primary">{referral_user}</span>
                                            </p>
                                            <p class="mb-1"><?php echo e(trans('labels.new_user')); ?> :
                                                <span class="pull-right text-primary">{new_user}</span>
                                            </p>
                                            <p class="mb-1"><?php echo e(trans('labels.company_name')); ?> :
                                                <span class="pull-right text-primary">{company_name}</span>
                                            </p>
                                            <p class="mb-1"><?php echo e(trans('labels.referral_amount')); ?> :
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label fw-bold"><?php echo e(trans('labels.email_message')); ?>
                                                    ...
                                                    <span class="text-danger"> * </span> </label>
                                                <textarea class="form-control" name="referral_earning_email_message" cols="50" rows="10"><?php echo e(@$settingdata->referral_earning_email_message); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/email_template/setting_form.blade.php ENDPATH**/ ?>