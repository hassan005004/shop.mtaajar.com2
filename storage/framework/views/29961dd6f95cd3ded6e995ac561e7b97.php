...
<div class="col">
    <div
        ...
        <div class="card-img position-relative">
            ...
            <?php if($off > 0): ?>
                <div class="off-label-12 <?php echo e(session()->get('direction') == 2 ? 'rtl' : ' '); ?>">
                    ...
                    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>"
                        ...
                        <div class="btn btn-secondary w-100 rounded-0">
                            <p class="fw-500 fs-7 text-capitalize d-flex justify-content-center">
                                <i
                                    class="fa-sharp fa-regular fa-cart-plus px-2 d-lg-block d-none"></i><?php echo e(trans('labels.addtocart')); ?>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-12/productcomonview.blade.php ENDPATH**/ ?>