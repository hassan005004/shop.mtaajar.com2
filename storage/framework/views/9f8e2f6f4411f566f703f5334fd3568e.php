...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group 2 selecttype">
                                    ...
                                    <input type="text" class="form-control numbers_only" name="plan_days"
                                        value="<?php echo e($editplan->days); ?>" placeholder="<?php echo e(trans('labels.days')); ?>"> 
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label class="form-label"><?php echo e(trans('labels.features')); ?><span
                                                class="text-danger">
                                                * </span></label>
                            ...
                            <div class="form-group col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="plan_description" placeholder="<?php echo e(trans('labels.description')); ?>"
                                        required><?php echo e($editplan->description); ?></textarea>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/plan/edit_plan.blade.php ENDPATH**/ ?>