...
<div class="col theme-10-best-Selling-product">
    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
        ...
        <div class="card border-0 rounded-3 position-relative h-100 <?php echo e(session()->get('direction') == 2 ? 'rtl' : ''); ?>">
                ...
                <div>
                    <div class="card-body p-sm-3 p-2 h-139 h-157">
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mt-sm-2 mt-2">
                            ...
                            <?php if($off > 0): ?>
                                <div class="sale-label-10 rounded-2"><?php echo e($off); ?>% <?php echo e(trans('labels.off')); ?>
                        ...
                        <div class="card-img position-relative">
                            ...
                            <ul
                                ...
                                <?php if(@helper::checkaddons('customer_login')): ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <li tooltip="<?php echo e(trans('labels.view')); ?>" class="m-0">
                                ...
                                <?php if(helper::appdata($vendordata->id)->online_order == 1): ?>
                                    <li tooltip="<?php echo e(trans('labels.add_to_cart')); ?>" class="rounded-circle m-0">
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-10/productcomonview.blade.php ENDPATH**/ ?>