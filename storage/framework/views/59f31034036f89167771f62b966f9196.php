...
<div class="col">
    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
        <div
            class="card border-0 rounded-0 overflow-hidden h-100 theme-2-card pro-menu <?php echo e(session()->get('direction') == 2 ? 'rtl' : 'ltr'); ?>">
            <div class="card-img position-relative">
                ...
                <?php if($off > 0): ?>
                    <div class="offer <?php echo e(session()->get('direction') == 2 ? 'rtl' : 'ltr'); ?>"><?php echo e($off); ?>%
                ...
                <!-- options -->
                <ul class="option-wrap <?php echo e(session()->get('direction') == 2 ? 'rtl' : 'ltr'); ?>">
            ...
            <div class="card-body px-0">
                <h5 class="card-title text-capitalize text-secondary fs-8 mb-1 theme-2 text-truncate">
                    <?php echo e(@$getproductdata['category_info']->name); ?></h5>
                <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
                    <p class="card-text text-dark text-capitalize fw-600 line-2 fs-7"><?php echo e($getproductdata->name); ?></p>
                </a>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <h5
                        ...
                        <?php if($original_price > $price): ?>
                            <del
                                class="text-muted fs-8 offer-price fw-500"><?php echo e(helper::currency_formate($original_price, $getproductdata->vendor_id)); ?></del>
                        <?php endif; ?>
                    </h5>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-2/productcomonview.blade.php ENDPATH**/ ?>