    ...
    <div class="card border-0 box-shadow h-100 <?php echo e($plan_id == $plandata->id ? 'plan-card-active' : 'border-0'); ?> handle">
        <div class="card-header bg-secondary sub-plan text-light">
            <div class="d-flex justify-content-between">
                <h5 class="text-light"><?php echo e($plandata->name); ?></h5>
        ...
        <div class="card-footer bg-white border-top-0 my-2 text-center">
            <?php if(Auth::user()->type == '1'): ?>
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(URL::to('admin/plan/edit-' . $plandata->id)); ?>" class="btn btn-info hov btn-sm"
            ...
            <?php else: ?>
                            ...
                            <?php else: ?>
                                <?php if(@$data['original']['plan_date'] > date('Y-m-d')): ?>
                                    <small class="text-dark d-block"><?php echo e(@$data['original']['plan_message']); ?>
                                        ...
                                        : <span
                                            class="text-success"><?php echo e($data['original']['plan_date'] != '' ? helper::date_formate($data['original']['plan_date'], $vendor_id) : ''); ?></span></small>
                                <?php else: ?>
                                    <small class="text-dark d-block"><?php echo e(@$data['original']['plan_message']); ?>

                                        : <span
                                            class="text-danger"><?php echo e($data['original']['plan_date'] != '' ? helper::date_formate($data['original']['plan_date'], $vendor_id) : ''); ?></span></small>
                                <?php endif; ?>
                            <?php endif; ?>
                            ...
                            <?php if(@$data['original']['plan_date'] > date('Y-m-d')): ?>
                                <small class="text-dark d-block"><?php echo e(@$data['original']['plan_message']); ?>
                                    ...
                                    <span class="text-success">
                                        <?php echo e($data['original']['plan_date'] != '' ? helper::date_formate($data['original']['plan_date'], $vendor_id) : ''); ?>
                            ...
                            <?php else: ?>
                                <small class="text-dark d-block"><?php echo e(@$data['original']['plan_message']); ?>
                                    ...
                                    <span class="text-danger">
                                        <?php echo e($data['original']['plan_date'] != '' ? helper::date_formate($data['original']['plan_date'], $vendor_id) : ''); ?></span>
                                </small>
                                <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>"
                            ...
                            <?php if($data['original']['plan_date'] != ''): ?>
                                <small class="text-dark">
                                    <?php echo e(@$data['original']['plan_message']); ?>: <span
                                        class="text-success"><?php echo e($data['original']['plan_date'] != '' ? helper::date_formate($data['original']['plan_date'], $vendor_id) : ''); ?></span>
                                </small>
                                <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>"
                ...
                <?php else: ?>
                    <?php if($plandata->price > 0): ?>
                        <a href="<?php echo e(URL::to('admin/plan/selectplan-' . $plandata->id)); ?>"
                            class="btn btn-sm btn-primary d-block py-2<?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_pricing_plans', Auth::user()->role_id, $vendor_id, 'manage') == 1 ? '' : 'd-none') : ''); ?>"><?php echo e(trans('labels.subscribe')); ?></a>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/plan/plancommon.blade.php ENDPATH**/ ?>