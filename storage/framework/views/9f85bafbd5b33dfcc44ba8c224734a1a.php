    ...
    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
        ...
        <div class="card bg-primary-rgb-card rounded-3 h-100 overflow-hidden theme-8">
            <div class="card-img position-relative">
                ...
                <?php if($off > 0): ?>
                    <div class="sale-label-8 <?php echo e(session()->get('direction') == 2 ? 'rtl' : ' '); ?>">
                        ...
                        <?php if($getproductdata->has_variation == 1): ?>
                            <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>"
                                ...
                                <div class="product-cart-button w-100">
                                    ...
                                    <p class="px-2 fw-500 text-capitalize fs-7"><?php echo e(trans('labels.add_to_cart')); ?></p>
                                </div>
                            </a>
                        <?php else: ?>
            ...
            <div class="card-body px-sm-3 px-2 pt-3 pb-0">
                    ...
                    <?php if(@helper::checkaddons('product_reviews')): ?>
                        <?php if(helper::appdata($vendordata->id)->product_ratting_switch == 1): ?>
                            <p class="fs-8 d-flex"><i class="text-warning fa-solid fa-star px-1"></i><span
                                    class="text-lightslategray fs-9 fw-500"><?php echo e(number_format($getproductdata->ratings_average, 1)); ?></span>
                            </p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                ...
                <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
                    <p class="text-white product-name line-2"><?php echo e($getproductdata->name); ?></p>
                </a>
            ...
            <div class="card-footer px-sm-3 px-2 py-2 ">
                ...
                <h5 class="text-white fw-semibold fs-7 product-price-size cursor-auto text-truncate">
                    ...
                    <?php if($original_price > $price): ?>
                        <del
                            class="fs-8 fw-500 d-block mt-1 text-lightslategray"><?php echo e(helper::currency_formate($original_price, $getproductdata->vendor_id)); ?></del>
                    <?php endif; ?>
                </h5>
            </div>
        </div>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-8/productcomonview.blade.php ENDPATH**/ ?>