...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <h5 class="text-capitalize fw-600 text-dark fs-4"><?php echo e(trans('labels.global_extras')); ?></h5>

        <a href="<?php echo e(URL::to('admin/extras/add')); ?>"
            class="btn btn-secondary px-sm-4 text-capitalize d-flex <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>"><i
                            ...
                            <tbody id="tabledetails" data-url="<?php echo e(url('admin/extras/reorder_extras')); ?>">
                                ...
                                <?php $__currentLoopData = $allextras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extras): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="fs-7 align-middle row1" id="dataid<?php echo e($extras->id); ?>"
                                        ...
                                        <td><?php echo e(helper::date_formate($extras->created_at, $vendor_id)); ?><br>
                                            <?php echo e(helper::time_formate($extras->created_at, $vendor_id)); ?>

                                        </td>
                                        <td><?php echo e(helper::date_formate($extras->updated_at, $vendor_id)); ?><br>
                                            <?php echo e(helper::time_formate($extras->updated_at, $vendor_id)); ?>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="<?php echo e(URL::to('admin/extras/edit-' . $extras->id)); ?>"
                                                    ...
                                                    class="btn btn-info btn-sm hov <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>">
                                                ...
                                                <a tooltip="<?php echo e(trans('labels.delete')); ?>"
                                                    ...
                                                    class="btn btn-danger btn-sm hov <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'delete') == 1 ? '' : 'd-none') : ''); ?>">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/extras/index.blade.php ENDPATH**/ ?>