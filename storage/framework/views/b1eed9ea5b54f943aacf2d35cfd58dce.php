    ...
    <nav class="navbar navbar-expand-lg bg-white underline fixed-top position-sticky">
        <div class="container-fluid gap-2">
            <div class="col-lg-4 col-md-4 d-none d-md-block d-flex flex-column">
                <p class="fs-4 fw-semibold m-0 text-dark line-1"><?php echo e(trans('labels.pos_welcome_title')); ?></p>
                <p class="fs-7 fw-normal m-0 line-1"><?php echo e(trans('labels.pos_welcome_description')); ?></p>
            </div>
            ...
            <div class="col-lg-4 col-6 col-sm-8 col-md-4 d-sm-block d-none">
                <div class="input-group gap-0 rounded">
                    <div class="input-group">
                        <span
                            class="input-group-text bg-white <?php echo e(session()->get('direction') == 2 ? 'rounded-start-0 rounded-end' : 'rounded-end-0 rounded-start'); ?>">
                        ...
                        <button
                            class="input-group-text btn fs-7 fw-500 btn-primary <?php echo e(session()->get('direction') == 2 ? 'rounded-end-0 rounded-start' : 'rounded-start-0 rounded-end'); ?>">
    ...
    <div class="container-fluid">
        ...
        <?php if($cartitems->count() > 0): ?>
            <button id="cart_btn" onclick="callcartview()"
                class="position-fixed cart-btn border border-1 z-3 text-light rounded-circle <?php echo e(session()->get('direction') == 2 ? 'cart-btn-right' : 'cart-btn-left'); ?>"
                ...
                <div class="cart-count bg-dark rounded-circle d-flex align-items-center justify-content-center">
                    <?php echo e($cartitems->count()); ?></div>
                <i class="fa-regular fa-cart-plus fs-4"></i>
            </button>
        <?php endif; ?>

        <div
            class="sidebares <?php echo e(session()->get('direction') == 2 ? 'sidebares-right' : 'sidebares-left'); ?> bg-white d-md-block d-flex">
                ...
                <li class="nav-item">
                    <div class="d-flex sidebr-box align-items-center actives justify-content-center text-center cursor-pointer"
                        ...
                        <a class="d-flex flex-column gap-1 fw-500">
                            ...
                            <p class="line-2 fs-8 m-0 lh-sm text-capitalize fw-500"><?php echo e(trans('labels.all_category')); ?></p>
                        </a>
                    </div>
                </li>
                <?php $__currentLoopData = $getcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-item">
                        <div class="d-flex sidebr-box align-items-center justify-content-center text-center cursor-pointer"
                            ...
                            <a class="d-flex flex-column gap-1 fw-500">
                                <span class="category-name">
                                    <img src="<?php echo e(helper::image_path($category->image)); ?>" class="img-fluid rounded hw-50"
                                        alt="">
                                </span>
                                <p class="line-2 lh-sm fs-8 fw-500 m-0 text-capitalize"><?php echo e($category->name); ?></p>
                            </a>
                        </div>
                    </li>
        ...
        <div class="<?php echo e(session()->get('direction') == 2 ? 'main-product-right' : 'main-product'); ?> pt-2">
            <div id="pos-item">
                        ...
                        <div class="row gx-2 flex-wrap align-items-center justify-content-between">
                            <div class="col-md-6 order_success">
                                <a type="button" id="order_id" target="new"
                                    class="rounded border fw-500 w-100 border-dark fs-13 total-pay1 text-dark text-center bg-gray mt-2 mt-lg-0"><?php echo e(trans('labels.view_order')); ?></a>
                            </div>
                            <div class="col-md-6 order_success">
                                <a href="<?php echo e(URL::to('admin/pos')); ?>" id="button2"
                                    class="w-100 fw-500 rounded btn-primary btn fs-13 total-pay1 mt-2 mt-lg-0"><?php echo e(trans('labels.continue_shopping')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        function currency_formate(price) {
            ...
            if ("<?php echo e(@helper::appdata($vendor_id)->currency_position); ?>" == "1") {
                ...
                if ("<?php echo e(helper::appdata($vendor_id)->decimal_separator); ?>" == 1) {
                    ...
                    if ("<?php echo e(helper::appdata($vendor_id)->currency_space); ?>" == 1) {
                        var newprice = (parseFloat(price).toFixed("<?php echo e(helper::appdata($vendor_id)->currency_formate); ?>")) +
                            " " + "<?php echo e(@helper::appdata($vendor_id)->currency); ?>";
                    } else {
                        var newprice = (parseFloat(price).toFixed("<?php echo e(helper::appdata($vendor_id)->currency_formate); ?>")) +
                            "<?php echo e(@helper::appdata($vendor_id)->currency); ?>";
...
<?php echo $__env->make('admin.layout.pos_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/pos/index.blade.php ENDPATH**/ ?>