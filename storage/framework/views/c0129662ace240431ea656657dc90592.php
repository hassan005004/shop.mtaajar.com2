<?php $__env->startSection('content'); ?>
        <h5 class="text-capitalize fw-600 fs-4 text-dark"><?php echo e(trans('labels.terms_condition')); ?></h5>
    <div class="row mt-3">
                ...
                <div class="card-body">
                    ...
                    <div id="privacy-policy-three" class="privacy-policy">
                        ...
                        <form action="<?php echo e(URL::to('admin/termscondition/update')); ?>" method="post">
                            ...
                            <textarea class="form-control" id="ckeditor" name="termscondition"><?php echo e(@$getterms); ?></textarea>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/other/termscondition.blade.php ENDPATH**/ ?>