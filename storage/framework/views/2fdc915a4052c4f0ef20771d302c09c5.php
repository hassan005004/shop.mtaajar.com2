                ...
                <form action="<?php echo e(URL::to('/admin/pixcel_settings')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="facebook_pixcel_id" class="form-label"><?php echo e(trans('labels.facebook')); ?> </label>
                        ...
                        <div class="col-md-6 form-group">
                            <label for="linkedin_pixcel_id" class="form-label"><?php echo e(trans('labels.linkedin')); ?> </label>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/pixel/pixel_setting.blade.php ENDPATH**/ ?>