...
<div class="col card-border-main">
    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
        <div class="position-relative h-100">
            <div
                class="card overflow-hidden h-100 p-2 theme-7-border border-0 <?php echo e(session()->get('direction') == 2 ? 'rtl-card' : ' '); ?>">
                ...
                <div class="card-footer px-0 pt-2 pb-md-2 pb-1">
                    ...
                    <h5 class="text-dark fs-7 fw-semibold product-price-size cursor-auto text-truncate">
                        ...
                        <?php if($original_price > $price): ?>
                            <del
                                class=" fs-8 fw-500 text-muted d-block mt-1"><?php echo e(helper::currency_formate($original_price, $getproductdata->vendor_id)); ?></del>
                        <?php endif; ?>
                    </h5>
                </div>
            </div>
            <div class="card-drop-border <?php echo e(session()->get('direction') == 2 ? 'rtl-card' : ' '); ?>"></div>
        </div>
    </a>
</div>
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-7/productcomonview.blade.php ENDPATH**/ ?>