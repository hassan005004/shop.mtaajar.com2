...
<?php $__env->startSection('content'); ?>
    <div class="d-flex align-items-center mb-3">
        <h5 class="text-capitalize fw-600 text-dark fs-4"><?php echo e(trans('labels.payment_settings')); ?></h5>
    </div>
    <div class="row">
        <div class="col-12">
                            ...
                            <form action="<?php echo e(URL::to('admin/payment/update')); ?>" method="POST" class="payments"
                                ...
                                <?php if($systemAddonActivated): ?>
                                    ...
                                    <div class="payment-accordian card rounded border mb-3 handle">
                                        <h2 class="card-header text-white d-flex align-items-center rounded border-0 justify-content-between"
                                            ...
                                            <div>
                                                ...
                                                <?php if(!in_array($transaction_type, ['1', '16'])): ?>
                                            ...
                                            <a class="cursor-pointer text-white" tooltip="<?php echo e(trans('labels.move')); ?>"><i
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <?php elseif($transaction_type == 1 || $transaction_type == 16): ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="image" class="form-label">
                                                                <?php echo e(trans('labels.image')); ?> </label>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/payment/payment.blade.php ENDPATH**/ ?>