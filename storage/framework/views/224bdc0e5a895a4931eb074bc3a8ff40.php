...
<head>
    ...
    <meta property="og:title" content="<?php echo e(@helper::appdata($vendor_id)->meta_title); ?>" />
    <meta property="og:description" content="<?php echo e(@helper::appdata($vendor_id)->meta_description); ?>" />
    <meta property="og:image" content="<?php echo e(helper::image_path(@helper::appdata($vendor_id)->og_image)); ?>" />
    <link rel="icon" href="<?php echo e(helper::image_path(@helper::appdata($vendor_id)->favicon)); ?>" type="image"
        sizes="16x16">
    <title><?php echo e(@helper::appdata($vendor_id)->web_title); ?></title>
    ...
    <main>
        <div class="wrapper">
            ...
            <footer class="py-3 text-center bg-white fixed-bottom border-top">
                <span><?php echo e(@helper::appdata(Auth::user()->id)->copyright); ?></span>
            </footer>
        </div>
    </main>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/layout/default.blade.php ENDPATH**/ ?>