        ...
        <div class="col-12">
            ...
            <div class="card border-0 box-shadow">
                <div class="card-header p-3 bg-secondary">
                    <h5 class="text-capitalize fw-600"><?php echo e(trans('labels.pwa_settings')); ?></h5>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input id="pwa-switch" type="checkbox" class="checkbox-switch" name="pwa"
                                    value="1" <?php echo e($settingdata->pwa == 1 ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group col-sm-6">
                                <label class="form-label"><?php echo e(trans('labels.app_logo')); ?> (512 x
                                    512)</label>
...
unset($__errorArgs, $__bag); ?>
                                <img class="img-fluid rounded mt-1 object-fit-contain img-height"
                                    src="<?php echo e(helper::image_path(@$settingdata->app_logo)); ?>" alt="">
                            </div>
                            <div class="form-group col-sm-6">

                                <label class="form-label"><?php echo e(trans('labels.app_title')); ?></label>

                                <input type="text" class="form-control" name="app_title"
                                    value="<?php echo e($settingdata->app_title); ?>"
                                    placeholder="<?php echo e(trans('labels.app_title')); ?>" required>

                            </div>

                            <div class="form-group col-sm-6">

                                <label class="form-label"><?php echo e(trans('labels.app_name')); ?></label>

                                <input type="text" class="form-control" name="app_name"
                                    value="<?php echo e($settingdata->app_name); ?>" placeholder="<?php echo e(trans('labels.app_name')); ?>"
                                    required>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/pwa/pwa_settings.blade.php ENDPATH**/ ?>