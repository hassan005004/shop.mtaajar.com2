...
<div class="col-xl-4 col-md-6 col-12">
    ...
    <div class="item h-100 d-flex bg-white rounded-0 align-items-center">
        ...
        <div
            class="col-lg-8 col-md-7 col-sm-8 col-7 h-100 position-relative py-2 <?php echo e(session()->get('direction') == 2 ? 'pe-sm-3 pe-2 ps-2' : 'ps-sm-3 ps-2 pe-2'); ?>">
            ...
            <ul class="option-wrap d-flex gap-2 align-items-center d-grid product_icon2 mt-3">
                <?php if(@helper::checkaddons('customer_login')): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <li tooltip="<?php echo e(trans('labels.view')); ?>" class="rounded-0 shadow">
                ...
                <?php if(helper::appdata($vendordata->id)->online_order == 1): ?>
                    <li tooltip="<?php echo e(trans('labels.addtocart')); ?>" class="rounded-0 shadow">
        ...
        <div class="col-lg-4 col-md-5 col-sm-4 col-5 item-img position-relative">
            ...
            <?php if($off > 0): ?>
                <div class="off-label-15 <?php echo e(session()->get('direction') == 2 ? 'rtl' : ' '); ?>">
                    <div class="sale-label-15 rounded-0"><?php echo e($off); ?>% <?php echo e(trans('labels.off')); ?></div>
                </div>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-15/newproductcomonview.blade.php ENDPATH**/ ?>