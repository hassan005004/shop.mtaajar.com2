        ...
        <div class="position-relative h-100">
            ...
            <div class="item h-100 p-2 d-flex">
                ...
                <div class="col-5">
                    ...
                    <div class="item-img position-relative overflow-hidden theme-7-border">
                        ...
                        <?php if($off > 0): ?>
                            <div class="sale-label-7"><?php echo e($off); ?>% <?php echo e(trans('labels.off')); ?></div>
                        <?php endif; ?>
                ...
                <div class="col-7 px-1">
                    ...
                    <div class="card-body item-content p-2 pb-0 h-150">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <p class="item-title fs-8 cursor-auto text-truncate text-capitalize">
                        ...
                        <h5 class="text-dark fs-7 fw-semibold product-price-size mt-3 mb-2 cursor-auto text-truncate">
                            ...
                            <?php if($original_price > $price): ?>
                                <del
                                    class=" fs-8 fw-500 d-block mt-1"><?php echo e(helper::currency_formate($original_price, $getproductdata->vendor_id)); ?></del>
                            <?php endif; ?>
                        </h5>
                    ...
                    <div class="card-footer d-md-block d-none">
                        <!-- options -->
                        <ul class="option-wrap d-flex align-items-center d-grid product_icon2 mt-2 w-100">
                            <?php if(@helper::checkaddons('customer_login')): ?>
            ...
            <div class="card-drop-border"></div>
        </div>
    </a>
</div>
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-7/newproductcomonview.blade.php ENDPATH**/ ?>