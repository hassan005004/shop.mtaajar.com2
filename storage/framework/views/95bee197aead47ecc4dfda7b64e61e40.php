...
<div class="col-xl-4 col-md-6 col-12">
    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
        <!-- product item start -->
        <div class="item border h-100 p-2 d-flex bg-white rounded-2 align-items-center  ">
            <!-- img start -->
            <div class="item-img position-relative">
                <img src="<?php echo e($getproductdata['product_image']->image_url); ?>" alt="product image"
                    class="object-fit-cover img-1 rounded-3">
            ...
            <div class="w-100 h-100 position-relative <?php echo e(session()->get('direction') == 2 ? 'pe-md-3 pe-2' : 'ps-3'); ?>">
                <div class="item-content p-0">
                    ...
                    <a href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $getproductdata->slug)); ?>">
                        <p class="text-dark product-name line-2 h-49"><?php echo e($getproductdata->name); ?></p>
                    </a>
                ...
                <div class="p-0">
                    <h6
                        class="text-dark fs-7 fw-600 mt-lg-3 mt-2 mb-2 cursor-auto text-truncate d-sm-flex align-items-center">
                        <?php echo e(helper::currency_formate($price, $getproductdata->vendor_id)); ?>

                        <?php if($original_price > $price): ?>
                            <del
                                class="text-muted fs-8 fw-normal d-block px-sm-1"><?php echo e(helper::currency_formate($original_price, $getproductdata->vendor_id)); ?></del>
                        <?php endif; ?>
                    </h6>
                </div>
                <!-- options -->
                <ul class="option-wrap d-flex gap-2 align-items-center d-grid product_icon2 mt-2">
                    <?php if(@helper::checkaddons('customer_login')): ?>
                        <?php if(helper::appdata($vendordata->id)->checkout_login_required == 1): ?>
                            <li tooltip="Wishlist" class="rounded-3 border">
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <li tooltip="<?php echo e(trans('labels.view')); ?>" class="rounded-3 border">
                    ...
                    <?php if(helper::appdata($vendordata->id)->online_order == 1): ?>
                        <li tooltip="<?php echo e(trans('labels.addtocart')); ?>" class="rounded-3 border">
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-14/newproductcomonview.blade.php ENDPATH**/ ?>