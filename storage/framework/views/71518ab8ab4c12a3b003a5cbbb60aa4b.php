        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 gap-2">
                    ...
                    <li class="text-muted breadcrumb-item active d-flex gap-2" aria-current="page"><?php echo e(trans('landing.terms_conditions')); ?></li>
                </ol>
            </nav>
        </div>
    </section>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/landing/terms_condition.blade.php ENDPATH**/ ?>