            ...
            <section class="theme-2-category my-5">
                <div class="container">
                    <div class="title d-flex align-items-center justify-content-between pb-3">
                        <div>
                            <span class="category-title p-0"><?php echo e(trans('labels.top_categories')); ?></span>
                            <p class="fs-7 text-muted fw-normal"><?php echo e(trans('labels.homepage_category_subtitle')); ?></p>
                        </div>
                        <a href="<?php echo e(URL::to(@$vendordata->slug . '/categories')); ?>"
                            class="btn btn-sm btn-outline-secondary category-button"><?php echo e(trans('labels.viewall')); ?>
                                        ...
                                        <div class="cat-img">
                                            ...
                                            <div class="cat-title fs-15">
                                                <span class="text-truncate fw-normal">
                                                    <?php echo e($categorydata['name']); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <?php if(count($getbestsellingproducts) > 0): ?>
            <section class="theme-2-new-products">
                <div class="container">
                    <div class="title d-flex align-items-center justify-content-between pb-3">
                        <div>
                            <span class="category-title p-0"><?php echo e(trans('labels.trending_products')); ?></span>
                            <p class="fs-7 text-muted fw-normal"><?php echo e(trans('labels.homepage_product_subtitle')); ?></p>
                        </div>
                                        ...
                                        <?php elseif($banner['type'] == 2): ?>
                                            ...
                                            <?php elseif($banner['type'] == 3): ?>
                                                ...
                                                <?php else: ?>
                                                    <a href="javascript:void(0)">
                                    <?php endif; ?>
                                    <img src="<?php echo e($banner['image']); ?>" class="d-block w-100" alt="..."></a>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
        ...
        <?php if(count($getnewarrivalproducts) > 0): ?>
            <section class="theme-2-new-arrival bg-primary-rgb py-5 mb-md-5 mb-3">
                <div class="container">
                    <div class="title d-flex align-items-center justify-content-between pb-3">
                        <div>
                            <span class="category-title p-0"><?php echo e(trans('labels.new_arrival_products')); ?></span>
                            <p class="fs-7 text-muted fw-normal"><?php echo e(trans('labels.new_arrival_product_subtitle')); ?></p>
                        </div>
                    ...
                    <div class="new-arrival-products">
                        <div class="row g-3 mb-4">
                            <?php $__currentLoopData = $getnewarrivalproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card product-card-side p-0 h-100 border-0 bg-white shadow">
                                        <div class="img-wrap h-100 position-relative">
                                            <a
                                                href="<?php echo e(URL::to(@$vendordata->slug . '/products/' . $productdata->slug)); ?>">
                                                <img src="<?php echo e($productdata['product_image']->image_url); ?>"
                                                    class="w-100 h-100 img-fluid object-fit-cover img-1" alt="">
                                                <img src="<?php echo e($productdata['multi_image']->count() > 1 ? $productdata['multi_image'][1]->image_url : $productdata['multi_image'][0]->image_url); ?>"
                                                    class="w-100 img-2" alt="">
                                            </a>

                                            <?php if($off > 0): ?>
                                                <div
                                                    class="<?php echo e(session()->get('direction') == 2 ? 'offer-rtl' : 'offer'); ?>">
                                                    <?php echo e($off); ?>% OFF</div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="card-body content-box w-100 p-xl-3 p-2">
                                            <div class="d-flex align-items-center justify-content-between mb-md-2">
                                                <p class="card-title fs-8 text-secondary m-0 text-truncate">
                                                    <?php echo e(@$productdata['category_info']->name); ?>
                                                    ...
                                                    <?php if(@helper::checkaddons('customer_login')): ?>
                                                        <?php if(helper::appdata($vendordata->id)->checkout_login_required == 1): ?>
                                                            <p class="fs-8">
                                                                ...
                                                                <span
                                                                    class="text-dark fw-500"><?php echo e(number_format($productdata->ratings_average, 1)); ?></span>
                                                            </p>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            ...
                                            <h6 class="text-dark fs-7 fw-semibold m-0 product-price text-truncate">
                                                <?php echo e(helper::currency_formate($price, $productdata->vendor_id)); ?>

                                                <?php if($original_price > $price): ?>
                                                    <del
                                                        class="text-muted fs-8 fw-500 fw-normal"><?php echo e(helper::currency_formate($original_price, $productdata->vendor_id)); ?></del>
                                                <?php endif; ?>
                                            </h6>
                                            ...
                                            <ul
                                                ...
                                                <li tooltip="View" class="rounded-circle">
                                                    <a class="circle-round wishlist-btn"
                                                        onclick="productview('<?php echo e($productdata->id); ?>')">
                                                    ...
                                                    <li tooltip="Add To Cart" class="rounded-circle">
                                                        ...
                                                        <?php else: ?>
                                                            <a class="circle-round addtocart-btn  wishlist-btn"
                                                                onclick="calladdtocart('<?php echo e($productdata->id); ?>','<?php echo e($productdata->slug); ?>','<?php echo e($productdata->name); ?>','<?php echo e($productdata['product_image'] == null ? 'product.png' : $productdata['product_image']->image); ?>','<?php echo e($productdata->tax); ?>','<?php echo e($price); ?>','','<?php echo e(URL::to(@$vendordata->slug . '/cart/add')); ?>','0')">
                                                                <i class="fa-sharp fa-regular fa-cart-plus"></i>
                                                            </a>
                                                        <?php endif; ?>
                                                    </li>
                ...
                <section class="Testimonial title mb-md-5 mb-3 border-0">
                    <div class="container">
                        <div class="mb-5 text-center">
                            <span class="category-title p-0"><?php echo e(trans('labels.testimonials')); ?>

                            </span>
                            <p class="fs-7 text-muted fw-normal"><?php echo e(trans('labels.testimonial_subtitle')); ?></p>
                        </div>
                                                        ...
                                                        <div class="row justify-content-between align-items-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mx-md-0 mx-auto">
                                                                    ...
                                                                    <span
                                                                        class="pb-0 text-muted fs-7 fw-400 text-capitalize"><?php echo e(helper::date_formate($testimonial->created_at, $testimonial->vendor_id)); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php elseif($banner['type'] == 2): ?>
                                        ...
                                        <?php elseif($banner['type'] == 3): ?>
                                            ...
                                            <?php else: ?>
                                                <a href="javascript:void(0)">
                                <?php endif; ?>
                                <img src="<?php echo e($banner['image']); ?>" alt="banner-3" class="object-fit-cover rounded">
                                </a>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <div class="container py-5">
                            <div class="title d-lg-flex align-items-center justify-content-between pb-3">
                                <div class="text-center text-md-start mb-3 mb-md-0">
                                    <span
                                        class="category-title text-dark p-0"><?php echo e(trans('labels.home_page_top_deals_subtitle')); ?></span>
                                    ...
                                    <a href="<?php echo e(URL::to(@$vendordata->slug . '/topdeals?type=1')); ?>"
                                        class="btn btn-sm btn-outline-secondary mt-2"><?php echo e(trans('labels.viewall')); ?>
                                            ...
                                            <div class="owl-item overflow-hidden">
                                                ...
                                                <div class="item h-100">
                                                    <a
                                                        ...
                                                        <div
                                                            class="card bg-white border-0 bg-transparent h-100 theme-2-card pro-menu <?php echo e(session()->get('direction') == 2 ? 'rtl' : 'ltr'); ?>">
                                                                    ...
                                                                    <?php if(helper::appdata($vendordata->id)->online_order == 1): ?>
                                                                        <li class="<?php echo e(session()->get('direction') == 2 ? 'tooltip-right' : 'tooltip-left'); ?> rounded-circle"
                                                                            ...
                                                                            <?php if($products->has_variation == 1): ?>
                                                                                <a href="<?php echo e(request()->has('type') && request()->get('type') == 1 ? URL::to(@$vendordata->slug . '/products/' . $products->slug . '?type=1') : URL::to(@$vendordata->slug . '/products/' . $products->slug)); ?>"
                                                                                    class="circle-round addtocart-btn wishlist-btn">
                                                                                    <i
                                                            ...
                                                            <div class="card-footer px-0">
                                                                <div
                                                                    ...
                                                                    <h5
                                                                        ...
                                                                        <?php if($original_price > $price): ?>
                                                                            <del
                                                                                class="text-muted fs-8 fw-500 fw-normal"><?php echo e(helper::currency_formate($original_price, $products->vendor_id)); ?></del>
                                                                        <?php endif; ?>
                                                                    </h5>
                                                                    <?php if(@helper::checkaddons('product_reviews')): ?>
                    ...
                    <?php if(count(helper::getblogs(@$vendordata->id, '6', '')) > 0): ?>
                        <section class="theme-2-blog mb-5">
                            <div class="container">
                                <div class="title d-flex align-items-center justify-content-between pb-3">
                                    <div>
                                        <span class="category-title p-0"><?php echo e(trans('labels.featured_blogs')); ?></span>
                                        <p class="fs-7 text-muted fw-normal"><?php echo e(trans('labels.blog_title')); ?></p>
                                    </div>
                                    <a href="<?php echo e(URL::to(@$vendordata->slug . '/blogs')); ?>"
                                        class="btn btn-sm btn-outline-secondary category-button"><?php echo e(trans('labels.viewall')); ?><i
                                            ...
                                            <div class="card rounded h-100 border-0">
                                                ...
                                                <div class="card-footer px-0">
                                                    ...
                                                    <a href="<?php echo e(URL::to(@$vendordata->slug . '/blogs-' . $blog->slug)); ?>"
                                                        class="fs-15 text-center category-button"><?php echo e(trans('labels.readmore')); ?>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/web/theme-2/index.blade.php ENDPATH**/ ?>