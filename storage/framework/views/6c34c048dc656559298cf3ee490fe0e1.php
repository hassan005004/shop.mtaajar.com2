    ...
    <div class="col-12">
        ...
        <div class="card border-0 box-shadow">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e($url . '/update-' . $getbannerdata->id); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($getbannerdata->title); ?>" name="banner_title" placeholder="<?php echo e(trans('labels.title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($getbannerdata->sub_title); ?>" name="banner_subtitle" placeholder="<?php echo e(trans('labels.sub_title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <textarea rows="5" class="form-control" name="banner_description" placeholder="<?php echo e(trans('labels.description')); ?>" placeholder="<?php echo e(trans('labels.description')); ?>"><?php echo e($getbannerdata->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($getbannerdata->link_text); ?>" placeholder="<?php echo e(trans('labels.link_text')); ?>" name="banner_link_text">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <select class="form-select type" name="banner_info">
                                ...
                                <option value="1" <?php echo e($getbannerdata->type == '1' ? 'selected' : ''); ?>>

                                    <?php echo e(trans('labels.category')); ?>

                                </option>

                                <option value="2" <?php echo e($getbannerdata->type == '2' ? 'selected' : ''); ?>>

                                    <?php echo e(trans('labels.product')); ?>

                                </option>
                                <option value="3" <?php echo e($getbannerdata->type == '3' ? 'selected' : ''); ?>>

                                    <?php echo e(trans('labels.custom_link')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group 1 gravity">
                            ...
                            <select class="form-select" name="category" id="category">
                                ...
                                <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $getbannerdata->category_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6 form-group 2 gravity">
                            ...
                            <select class="form-select" name="product" id="product">
                                ...
                                <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $getbannerdata->product_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6 form-group 3 gravity">
                                ...
                                <input type="text" name="custom_link" class="form-control" value="<?php echo e($getbannerdata->custom_link); ?>" id="custom_link">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <img src="<?php echo e(helper::image_path($getbannerdata->image)); ?>" class="img-fluid rounded hw-50 mt-1" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group <?php echo e(session()->get('direction') == 2 ? 'text-start' : 'text-end'); ?>">
                            ...
                            <a href="<?php echo e($url); ?>" class="btn btn-danger px-sm-4"><?php echo e(trans('labels.cancel')); ?></a>

                            <button class="btn btn-primary px-sm-4 <?php echo e(Auth::user()->type == 4 ? (helper::check_access($title == trans('labels.sliders')  ? 'role_sliders' : 'role_banner', Auth::user()->role_id, Auth::user()->vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>" <?php if(env('Environment')=='sendbox' ): ?> type="button" onclick="myFunction()" <?php else: ?> type="submit" <?php endif; ?>><?php echo e(trans('labels.save')); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/banner/edit.blade.php ENDPATH**/ ?>