                    ...
                    <div class="card-header p-3 bg-secondary">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="text-capitalize fw-600 ">
                                <?php echo e(trans('labels.tawk_settings')); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control" name="widget_id" placeholder="<script type=&quot;text/javascript&quot;></script>" required><?php echo e(@$settingdata->tawk_widget_id); ?></textarea>
...
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/tawk_settings/index.blade.php ENDPATH**/ ?>