    ...
    <?php if(@helper::checkaddons('digital_product')): ?>
        ...
        <?php if(helper::appdata($vendor_id)->product_type == 2): ?>
            <div class="col-md-6 form-group">
                <label class="col-form-label"><?php echo e(trans('labels.digital_file')); ?></label>
                <input type="file" class="form-control" name="downloadfile" id="downloadfile">
                <p class="text-danger mt-2"><?php echo e(trans('labels.digital_file')); ?> : <span class="text-dark"> <a
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/product/digital_product.blade.php ENDPATH**/ ?>