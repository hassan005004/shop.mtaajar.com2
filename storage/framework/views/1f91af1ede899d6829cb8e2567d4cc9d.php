...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row settings">
        <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
            <h5 class="text-capitalize fw-600 text-dark fs-4"><?php echo e(trans('labels.language-settings')); ?></h5>
            <?php if(Auth::user()->type == 1): ?>
                ...
                <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                    <div
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a class="btn btn-sm btn-info hov" tooltip="<?php echo e(trans('labels.edit')); ?>"
                            ...
                            <?php if(Strtolower($currantLang->name) != 'english'): ?>
                                <a class="btn btn-danger hov" tooltip="<?php echo e(trans('labels.delete')); ?>"
                            ...
                            <table class="table table-striped table-bordered py-3 zero-configuration w-100">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = helper::listoflanguage(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="fs-7 align-middle" data-id="<?php echo e($language->id); ?>">
                                            <td><?php echo $i++ ?></td>
                                            ...
                                            <td>
                                                <?php if(in_array($language->code, explode('|', helper::appdata($vendor_id)->languages))): ?>
                                                    <a tooltip="<?php echo e(trans('labels.active')); ?>"
                                                        ...
                                                        class="btn btn-sm hov btn-outline-success">
                                                ...
                                                <?php else: ?>
                                                    <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                                        ...
                                                        class="btn btn-sm hov btn-outline-danger <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_language_settings', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>">
                                            ...
                                            <td>
                                                <?php if(helper::appdata($vendor_id)->default_language == $language->code): ?>
                                                    <a tooltip="<?php echo e(trans('labels.active')); ?>"
                                                        ...
                                                        class="btn btn-sm hov btn-success">
                                                        <i class="fas fa-check"></i>
                                                    </a>
                                                <?php else: ?>
                                                    <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                                        ...
                                                        class="btn btn-sm hov btn-danger <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_language_settings', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>">
                                                        <i class="fas fa-close mx-1"></i>
                                                    </a>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/admin/included/language/index.blade.php ENDPATH**/ ?>