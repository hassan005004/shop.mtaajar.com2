            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 gap-2">
                    ...
                    <li class="text-muted breadcrumb-item active d-flex gap-2" aria-current="page">
                        <?php echo e(trans('landing.privacy_policy')); ?></li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <div class="about-us-bg-color">
            <div class="container">
                <div class="about-us-main">
                    <?php if(!empty($privacypolicy->privacy_content)): ?>
                        <div class="cms-section my-3">

                            <?php echo $privacypolicy->privacy_content; ?>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtaajrco/shop.mtaajr.com/resources/views/landing/privacypolicy.blade.php ENDPATH**/ ?>