...
class PlanPricingController extends Controller
{
    ...
    public function success(Request $request)
    {
        try {
            ...
            $tax_amount = [];
            $tax_name = [];
            if ($plan->tax != null && $plan->tax != "" && $plan->tax != 0) {
    ...
    public function updateimage(Request $request)
    {
        if ($request->has('theme_image')) {
            ...
            if ($request->image_id == 16) {
                $theme_image = 'theme-16.png';
            }
            if ($request->image_id == 17) {
                $theme_image = 'theme-17.png';
            }
            if ($request->image_id == 18) {
                $theme_image = 'theme-18.png';
            }
            if ($request->image_id == 19) {
                $theme_image = 'theme-19.png';
            }
            if ($request->image_id == 20) {
                $theme_image = 'theme-20.png';
            }
