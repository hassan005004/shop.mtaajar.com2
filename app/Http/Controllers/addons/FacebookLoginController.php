        ...
        try {
            ...
            if (session()->get('logintype') == "user") {
                ...
                if ($request->logintype == "facebook") {
                    ...
                    $facebookuserdata = $this->configDriver('user', 'facebook',session()->get('slug'))->stateless()->user(); 
            ...
            if (session()->get('logintype') == "vendor") {
                ...
                if ($request->logintype == "facebook") {
                    ...
                    $facebookuserdata =  $this->configDriver('vendor', 'facebook',session()->get('slug'))->stateless()->user();
